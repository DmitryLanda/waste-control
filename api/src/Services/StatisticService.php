...
{
    public function __construct(private MoneyTransactionRepository $repository)
    {
    ...
    {
        return array_reduce($expenses, function (int $total, MoneyTransaction $expense) {
    ...
    {
        return array_reduce($expenses, function (array $result, MoneyTransaction $expense) {
    ...
    private function groupAmountByMonth(array $expenses): array
    {
        ...
        return array_reduce($expenses, function (array $result, MoneyTransaction $expense) use ($monthNames) {
